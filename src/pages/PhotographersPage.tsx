...
import { Camera, Search, Star, Phone, Instagram, Facebook, User, ChevronRight, LogIn } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        {/* Search */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-2 flex items-center gap-3 max-w-xl mb-6">
        ...
        {loading ? (
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-16 text-center">
            ...
            <p className="text-stone-500 text-sm">Хайлт эсвэл ангилал өөрчилж үзнэ үү.</p>
          </div>
        ) : (
          <>
            <p className="text-stone-500 text-sm mb-6">{filtered.length} зурагчин олдлоо</p>
                ...
                >
                  ...
                  <div className="p-4 -mt-8 relative">
                    ...
                    <div className="pt-3 border-t border-white/10 flex items-center gap-3 text-stone-500">
                      ...
                      {p.facebook && (
                        <a
                          href={p.facebook.startsWith('http') ? p.facebook : `https://${p.facebook}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          onClick={e => e.stopPropagation()}
